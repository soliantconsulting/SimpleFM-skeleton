...
return array(
    ...
    'service_manager' => array(
         ...
         * how you want a given class to be instantiated. the names of these sub-arrays are hardcoded, so you
         * need to learn their names and the difference between them:
         */
        'factories' => array(
            'simple_fm' => \Soliant\SimpleFM\ZF2\AdapterServiceFactory::class,
            'gateway_project' => \Application\Gateway\Factory\ProjectGatewayFactory::class,
            'gateway_task' => \Application\Gateway\Factory\TaskGatewayFactory::class,
        ),
        'invokables' => array(
//             /**
